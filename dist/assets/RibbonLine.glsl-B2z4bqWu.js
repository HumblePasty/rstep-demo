...
#define blendStipple(color, _stippleAlpha_) color`)}function $r(t){return t?(Math.floor(.5*(xr(t)-1))+.5)/t.pixelRatio:1}function Nt(t){const e=t.stipplePattern;return e?Rr(t.stipplePattern)/e.pixelRatio:1}const wr=p.float(.4),Ut=64,Nr=Ut/2,Ur=Nr/5,zr=Ut/Ur,La=.25;function jr(t,e){const i=t.vertex;Ye(i),i.uniforms.get("markerScale")==null&&i.constants.add("markerScale","float",1),i.constants.add("markerSizePerLineWidth","float",zr).code.add(p`float getLineWidth() {
